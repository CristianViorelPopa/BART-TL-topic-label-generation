...
word2vecmodel = "pre_trained_models/word2vec/glove_word2vec" # Path for Word2vec Model.
num_candidates = 100 # Number of candidates labels that need to generated for a topic.
output_filename = "output_candidates_" + output_suffix # Name of the output file that will store the candidate labels.
doc2vec_indices_file = "support_files/glove_doc2vec_indices" # The filtered doc2vec indices file. 
word2vec_indices_file = "support_files/glove_word2vec_indices" # The filtered word2vec indices file
...
out_unsup = "output_unsupervised_" + output_suffix # The Output File name for unsupervised labels
...
out_sup ="output_supervised_" + output_suffix # The output file for supervised labels.
