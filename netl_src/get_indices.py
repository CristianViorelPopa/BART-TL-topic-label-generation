...
word2vec_model = "model_run/pre_trained_models/word2vec/glove_word2vec" # Trained word2vec model
...
# Loading the phrasses used in training word2vec model. And then replacing space with underscore.
...
print("Short label word2vec tokenised loaded")
...
model2 = KeyedVectors.load_word2vec_format(word2vec_model, binary=False)
